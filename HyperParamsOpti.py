...
class PersClassifier(BaseEstimator, ClassifierMixin):
    ...
    def __init__(self, gsc_epsilon=net_config.epsilon, gsc_eps_decay=net_config.eps_decay,
                 ...
                 gsc_early_stopping=net_config.early_stopping,
    ...
    def fit(self, X, y=None):
        ...
        self._gsc_model_ = CuteLearning(epsilon=self.gsc_epsilon, eps_decay=self.gsc_eps_decay,
                                        ...
                                        reward_optimisation=self.gsc_reward_optimisation,
                                        early_stopping=self.gsc_early_stopping,
    ...
    def score(self, X, y=None):
        X = check_array(X)
        self._value = self._gsc_model_.eval()
        # check_X_y(X, X)
